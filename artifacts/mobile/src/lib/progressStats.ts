...
import type { AppTheme } from "@/theme/buildTheme";
...
export function getHeatmapLevelColors(
  theme: AppTheme,
  ...
  return [
    theme.appMuted,
    theme.main100,
    dark ? theme.main300 : theme.main200,
    dark ? theme.main500 : theme.main400,
    dark ? theme.main600 : theme.main500,
  ];
}

export function getHeatmapFutureColor(theme: AppTheme): string {
  return theme.appHeatmapAlternative;
}

export function getSrsDeckChartColors(theme: AppTheme): Record<SrsDeckType, string> {
  return {
    word: theme.main500,
    pronunciation: theme.main400,
    meaning: theme.main300,
    example: theme.main200,
    drawing: theme.main100,
  };
}
